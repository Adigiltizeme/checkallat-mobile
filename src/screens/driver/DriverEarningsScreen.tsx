...
export const DriverEarningsScreen = ({ navigation }: Props) => {
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    earningDate: { color: tokens.text.secondary },
    ...
    earningDetailText: { color: tokens.text.secondary },
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      {periodMode !== 'all' && (
        <View style={styles.periodNav}>
          ...
          >
            <Icon name="chevron-right" size={28} color={periodOffset >= 0 ? tokens.text.secondary : colors.primary} />
          </TouchableOpacity>
        </View>
      )}
                ...
                <Card.Content>
                  ...
                  <View style={styles.earningDetails}>
                    <View style={styles.earningDetail}>
                      <Icon name="map-marker-distance" size={16} color={tokens.text.secondary} />
                      <Text variant="bodySmall" style={styles.earningDetailText}>
                        {delivery.distance?.toFixed(1)} km
                      </Text>
                    </View>
                    <View style={styles.earningDetail}>
                      <Icon name="package-variant" size={16} color={tokens.text.secondary} />
                      <Text variant="bodySmall" style={styles.earningDetailText}>
