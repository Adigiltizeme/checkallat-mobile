...
export const MyBookingsScreen = ({ navigation }: Props) => {
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    serviceName: { fontSize: 14, fontWeight: '700', color: tokens.text.primary },
    proName: { fontSize: 12, color: tokens.text.secondary, marginTop: 2 },
    ...
    dateText: { fontSize: 12, color: tokens.text.secondary },

    centered: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: spacing.xl },
    emptyTitle: { fontSize: 15, fontWeight: '600', color: tokens.text.primary, textAlign: 'center', marginBottom: spacing.xs },
  ...
  const renderEmpty = () => (
    <View style={styles.centered}>
      <Icon name="calendar-blank-outline" size={56} color={tokens.border} style={{ marginBottom: spacing.md }} />
