...
export const ProDetailScreen = ({ route, navigation }: Props) => {
  ...
  badgePremium: { backgroundColor: tokens.primary + '20', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4 },
  badgePremiumText: { fontSize: 12, fontWeight: '700', color: tokens.primary },
        ...
        <View style={styles.statsGrid}>
          {pro.serviceAreaRadius && (
            <View style={styles.statCard}>
              <Icon name="map-marker-radius" size={22} color={tokens.primary} />
