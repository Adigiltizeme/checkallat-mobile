...
export const PaymentDetailsScreen = ({ route }: Props) => {
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    statusExplanation: { color: tokens.text.secondary, textAlign: 'center', lineHeight: 20 },
    ...
    rowLabel: { fontWeight: '600', color: tokens.text.primary },
    netAmount: { fontWeight: '700', color: tokens.primary },
    subLabel: { color: tokens.text.secondary, flex: 1 },
    subValue: { color: tokens.text.primary, textAlign: 'right', flex: 1 },
        ...
        <Card.Content>
          ...
          <View style={styles.row}>
            ...
            <Text variant="bodySmall" style={[
              styles.subValue,
              { color: payment.transferStatus === 'transferred' ? colors.success : tokens.text.secondary },
            ]}>
